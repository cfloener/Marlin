 ...
 */
  ...
  #define THERMAL_PROTECTION_PERIOD 60        //CF Seconds
  #define THERMAL_PROTECTION_HYSTERESIS 6     //CF Degrees Celsius
   ...
   * below 2.
   */
  #define WATCH_TEMP_PERIOD  60               //CF Seconds
 ...
 */
#define USE_CONTROLLER_FAN  //CF
#if ENABLED(USE_CONTROLLER_FAN)
  #define CONTROLLER_FAN_PIN FAN2_PIN            //CF Set a custom pin for the controller fan
  ...
  #define CONTROLLER_FAN_EDITABLE         //CF Enable M710 configurable settings
 ...
 */
#define E0_AUTO_FAN_PIN FAN1_PIN  //CF
...
#define QUICK_HOME                          //CF If G28 contains XY do a diagonal move first
...
// @section bltouch
   ...
   */
  #define BLTOUCH_HS_MODE false  //CF
 ...
 */
#define Z_STEPPER_AUTO_ALIGN  //CF
   ...
   */
  #define Z_STEPPER_ALIGN_XY { {  60, 180 }, { 300,  180 } }  //CF
  ...
  #define Z_STEPPER_ALIGN_ITERATIONS 15    //CF Number of iterations to apply during alignment
...
//
#define ASSISTED_TRAMMING  //CF
#if ENABLED(ASSISTED_TRAMMING)

  // Define positions for probe points.
  #define TRAMMING_POINT_XY { {  30, 30 }, { 180,  30 }, { 180, 180 }, { 30, 180 } }  //CF
  ...
  #define ASSISTED_TRAMMING_WIZARD    //CF Add a Tramming Wizard to the LCD menu
...
//#define LCD_BACKLIGHT_TIMEOUT_MINS 1  // (minutes) Timeout before turning off the backlight
  ...
  #define PROBE_OFFSET_WIZARD       //CF Add a Probe Z Offset calibration option to the LCD menu
...
#if HAS_DISPLAY
  #define SOUND_MENU_ITEM   //CF Add a mute option to the LCD menu
  ...
  #define STATUS_MESSAGE_SCROLLING  //CF
...
#define SET_PROGRESS_MANUALLY  //CF
...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  #define SHOW_REMAINING_TIME           //CF Display estimated time to completion (prefix 'R')
  ...
  #define LONG_FILENAME_HOST_SUPPORT    //CF Get the long filename of a file/folder with 'M33 <dosname>' and list long filenames with 'M20 L'
  //#define LONG_FILENAME_WRITE_SUPPORT   // Create / delete files with long filenames via M28, M30, and Binary Transfer Protocol
  //#define M20_TIMESTAMP_SUPPORT         // Include timestamps by adding the 'T' flag to M20 commands

  #define SCROLL_LONG_FILENAMES         //CF Scroll long filenames in the SD card menu
  ...
  #define AUTO_REPORT_SD_STATUS         //CF Auto-report media status with 'M27 S<seconds>'
   ...
   */
  #define SDCARD_CONNECTION ONBOARD  //CF
...
#define BABYSTEPPING  //CF
  ...
  #define DOUBLECLICK_FOR_Z_BABYSTEPPING  //CF Double-click on the Status Screen for Z Babystepping.
  ...
  #define BABYSTEP_DISPLAY_TOTAL          //CF Display total babysteps since last G28

  #define BABYSTEP_ZPROBE_OFFSET          //CF Combine M851 Z and Babystepping
...
// The value of BLOCK_BUFFER_SIZE must be a power of 2 (e.g., 8, 16, 32)
  ...
  #define BLOCK_BUFFER_SIZE  64  //CF
...
#define TX_BUFFER_SIZE 32  //CF

// Host Receive Buffer Size
// Without XON/XOFF flow control (see SERIAL_XON_XOFF below) 32 bytes should be enough.
// To use flow control, set this buffer size to at least 1024 bytes.
// :[0, 2, 4, 8, 16, 32, 64, 128, 256, 512, 1024, 2048]
#define RX_BUFFER_SIZE 2048  //CF
...
#define SERIAL_FLOAT_PRECISION 4  //CF
 ...
 */
#define ADVANCED_PAUSE_FEATURE  //CF
  ...
  #define FILAMENT_CHANGE_UNLOAD_LENGTH      400  //CF (mm) The length of filament for a complete unload.
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_LENGTH   350  //CF (mm) Load length of filament, from extruder gear to nozzle.
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
  ...
  #define PARK_HEAD_ON_PAUSE                    //CF Park the nozzle during pause and filament change.
  #define HOME_BEFORE_FILAMENT_CHANGE           //CF If needed, home before parking for filament change

  #define FILAMENT_LOAD_UNLOAD_GCODES           //CF Add M701/M702 Load/Unload G-codes, plus Load/Unload in the LCD Prepare menu.
 ...
 */
   ...
   */
  #define CHOPPER_TIMING CHOPPER_DEFAULT_24V        //CF All axes (override below)
   ...
   */
  #define MONITOR_DRIVER_STATUS  //CF
   ...
   */
  #define SQUARE_WAVE_STEPPING  //CF
 ...
 */
#define AUTO_REPORT_POSITION  //CF
...
#define EXTENDED_CAPABILITIES_REPORT
  ...
  #define M115_GEOMETRY_REPORT  //CF
#endif
...
#define M114_DETAIL         //CF Use 'M114` for details to check planner calculations
#define M114_REALTIME       //CF Real current position based on forward kinematics
//#define M114_LEGACY         // M114 used to synchronize on every call. Enable if needed.

#define REPORT_FAN_CHANGE   //CF Report the new fan speed when changed by M106 (and others)
...
#define MEATPACK_ON_SERIAL_PORT_1  //CF
#define MEATPACK_ON_SERIAL_PORT_2  //CF

#define GCODE_CASE_INSENSITIVE  //CF Accept G-code sent to the firmware in lowercase
 ...
 */
#define HOST_ACTION_COMMANDS  //CF
#if ENABLED(HOST_ACTION_COMMANDS)
  #define HOST_PAUSE_M76                //CF Tell the host to pause in response to M76
  #define HOST_PROMPT_SUPPORT           //CF Initiate host prompts to get user feedback
  #if ENABLED(HOST_PROMPT_SUPPORT)
    #define HOST_STATUS_NOTIFICATIONS   //CF Send some status messages to the host as notifications
  #endif
  #define HOST_START_MENU_ITEM          //CF Add a menu item that tells the host to start
