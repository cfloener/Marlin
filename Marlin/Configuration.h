...
#define STRING_CONFIG_H_AUTHOR "(E5P SKR-3-EZ-v1.0-2.1.x)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "E5P-SKR3 2.1.x"  //CF
 ...
 */
//#define PSU_CONTROL
#define PSU_NAME "Power Supply"  //CF
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Creality Ender-5 Plus, auto tune result of: M303 E0 S225 C10
    ...
    #define DEFAULT_Kp_LIST {  19.41,  19.41 }  //CF
    #define DEFAULT_Ki_LIST {   1.38,   1.38 }  //CF
    #define DEFAULT_Kd_LIST { 68.38, 68.38 }  //CF
  #else
    #define DEFAULT_Kp  19.41  //CF
    #define DEFAULT_Ki   1.38  //CF
    #define DEFAULT_Kd 68.38  //CF
  #endif
#endif
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 481.83  //CF
  #define DEFAULT_bedKi 69.20  //CF
  #define DEFAULT_bedKd 838.75  //CF
...
#define EXTRUDE_MAXLENGTH 400  //CF
...
//#define USE_XMIN_PLUG  //CF
//#define USE_YMIN_PLUG  //CF
...
#define USE_XMAX_PLUG  //CF
#define USE_YMAX_PLUG  //CF
 ...
 * :[2,3,4,5,6,7]
 */
#define ENDSTOP_NOISE_THRESHOLD 2  //CF
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 800, 130.00 }  //CF
/**
 * Default Max Feed Rate (linear=mm/s, rotational=°/s)
 * Override with M203
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 8000, 8000, 15, 15000 }  //CF

//#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
#if ENABLED(LIMITED_MAX_FR_EDITING)
  #define MAX_FEEDRATE_EDIT_VALUES    { 5000, 5000, 100, 1000 } // ...or, set your own edit limits
#endif
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 5000, 5000, 100, 10000 }  //CF
...
#define DEFAULT_EJERK    0.5  //CF May be used by Linear Advance
 ...
 */
#define S_CURVE_ACCELERATION  //CF
 ...
 */
//#define Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN  //CF

// Force the use of the probe for Z-axis homing
#define USE_PROBE_FOR_Z_HOMING  //CF
...
#define PROBING_MARGIN 20  //CF

// X and Y axis travel speed (mm/min) between probes
#define XY_PROBE_FEEDRATE (150*60)  //CF
...
#define Z_MIN_PROBE_REPEATABILITY_TEST  //CF
...
#define INVERT_X_DIR true  //CF
#define INVERT_Y_DIR true
#define INVERT_Z_DIR true  //CF
...
#define Z_HOMING_HEIGHT  10      //CF (mm) Minimal Z height before homing (G28) for Z clearance above the bed, clamps, ...
                                  // Be sure to have this much clearance over your Z_MAX_POS to prevent grinding.

#define Z_AFTER_HOMING  10      //CF (mm) Height to move to after homing Z

// Direction of endstops when homing; 1=MAX, -1=MIN
// :[-1,1]
#define X_HOME_DIR 1  //CF
#define Y_HOME_DIR 1  //CF
#define Z_HOME_DIR -1
//#define I_HOME_DIR -1
//#define J_HOME_DIR -1
//#define K_HOME_DIR -1
...
#define X_BED_SIZE 360  //CF
#define Y_BED_SIZE 360  //CF
//#define ClipClearance 25  //CF
...
#define MAX_SOFTWARE_ENDSTOPS
  ...
  #define SOFT_ENDSTOPS_MENU_ITEM  //CF Enable/Disable software endstops from the LCD
#endif
 ...
 */
#define FILAMENT_RUNOUT_SENSOR  //CF
...
#define AUTO_BED_LEVELING_BILINEAR  //CF
...
#define ENABLE_LEVELING_AFTER_G28  //CF

/**
 * Auto-leveling needs preheating
 */
#define PREHEAT_BEFORE_LEVELING  //CF
...
//#define DEBUG_LEVELING_FEATURE
  ...
  //#define PROBE_Y_FIRST
    ...
    #define EXTRAPOLATE_BEYOND_GRID  //CF
  ...
  #define MESH_EDIT_GFX_OVERLAY   //CF Display a graphics overlay while editing the mesh
  ...
  #define UBL_MESH_WIZARD         //CF Run several commands in a row to get a complete mesh
 ...
 */
#define LCD_BED_LEVELING  //CF

#if ENABLED(LCD_BED_LEVELING)
  #define MESH_EDIT_Z_STEP  0.025 // (mm) Step size while manually probing Z axis.
  #define LCD_PROBE_Z_RANGE 4     // (mm) Z Range centered on Z_MIN_POS for LCD Z adjustment
  #define MESH_EDIT_MENU        //CF Add a menu to edit mesh points
#endif

// Add a menu item to move between bed corners for manual bed adjustment
#define LCD_BED_TRAMMING  //CF
  ...
  #define BED_TRAMMING_USE_PROBE  //CF
 ...
 */
#define EEPROM_SETTINGS     //CF Persistent storage with M500 and M501
...
//
#define INDIVIDUAL_AXIS_HOMING_MENU  //CF
...
//
#define REPRAP_DISCOUNT_FULL_GRAPHIC_SMART_CONTROLLER  //CF
